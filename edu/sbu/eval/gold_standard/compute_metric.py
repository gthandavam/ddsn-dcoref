...
def main():
  ...
  #TODO: Make it general for a set of annotations, for different experiments

  brat_file = '/home/gt/svg-dir/UW_annotations/dot_files/chocolate-french-toast-2.gv'
  ...
  # print 'brat_file'
  node_map, edge_list = get_graph(brat_file)
  # print 'auto_file'
