...
def main():
  ...
  with open('/home/gt/Documents/so_report_viterbi.csv', 'w') as report:
    ...
    writer.writerow(['Dish', 'Features', 'TPR', 'FPR', 'Observed +', 'Observed -', 'SVM Classification Acc.', 'kTau average (Viterbi with SVM Prob)', 'global inference - Class. Acc. (Viterbi with SVM Prob)', 'kTau average (Viterbi with stats)', 'global inference - Class. Acc. (Viterbi with stats)'])
    for dish in dishes:
      # writer.writerow([dish])
      # writer.writerow(['Features', 'TPR', 'FPR', 'Observed +', 'Observed -', 'SVM Classification Acc.', 'kTau average (Viterbi with SVM Prob)', 'global inference - Class. Acc. (Viterbi with SVM Prob)', 'kTau average (Viterbi with CP{1,2,3,4})', 'global inference - Class. Acc. (Viterbi with CP{1,2,3,4})'])
